...
function openLegalModal(type) {
  ...
  if (type === 'mentions') {
    ...
    content.innerHTML = `
      ...
      <p>Le présent site internet accessible à l'adresse <strong>sushilin.fr</strong> est édité et exploité par la société :</p>
    ...
    content.innerHTML = `
      ...
      <p>Les présentes Conditions Générales de Vente (CGV) s'appliquent à l'ensemble des commandes de repas et produits passées sur le site <strong>sushilin.fr</strong> pour un retrait sur place (Click & Collect) ainsi qu'aux consommations sur place au restaurant <strong>SUSHI LIN</strong> (32 Rue des Dames, 78340 Les Clayes-sous-Bois).</p>

      <h4>2. Produits & Fraîcheur</h4>
      <p>Tous les plats proposés (sushis, makis, sashimis, yakitoris, chirashis et spécialités chaudes) sont préparés artisanalement à la commande avec des ingrédients rigoureusement sélectionnés afin de garantir une fraîcheur et une qualité optimales.</p>
